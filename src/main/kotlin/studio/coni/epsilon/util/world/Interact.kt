...
import studio.coni.epsilon.common.collections.EnumSet
...
fun SafeClientEvent.placeBlock(
    ...
    val sneak = !player.isSneaking && studio.coni.epsilon.util.items.blockBlacklist.contains(world.getBlock(placeInfo.pos))
