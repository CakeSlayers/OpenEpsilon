package studio.coni.epsilon.util.text
...
object ChatUtil : Helper {
    ...
    fun sendNoSpamMessage(message: String, messageID: Int) {
        sendNoSpamRawChatMessage(
            SECTION_SIGN + "7[" + SECTION_SIGN + "9" + EpsilonPlus.MOD_NAME + SECTION_SIGN + "7] " + SECTION_SIGN + "r" + message,
            messageID
        )
    }

    fun sendNoSpamMessage(message: String) {
        sendNoSpamRawChatMessage(SECTION_SIGN + "7[" + SECTION_SIGN + "9" + EpsilonPlus.MOD_NAME + SECTION_SIGN + "7] " + SECTION_SIGN + "r" + message)
    }
    ...
    fun printChatMessage(message: String) {
        printRawChatMessage(SECTION_SIGN + "7[" + SECTION_SIGN + "9" + EpsilonPlus.MOD_NAME + SECTION_SIGN + "7] " + SECTION_SIGN + "r" + message)
    }
