...
import studio.coni.epsilon.common.extensions.setupCameraTransform
                    ...
                    if (isValid(entity)) {
                        ...
                        if (position != null) {
                            ...
                            if (fill) {
                                ...
                                studio.coni.epsilon.util.graphics.RenderUtils2D.drawGradientRect((posX + width).toFloat(), (posY + width).toFloat(), endPosX.toFloat(), endPosY.toFloat(),
                                    color.alpha(0),
                                    color.alpha(0),
                                    color.alpha(alpha),
                                    color.alpha(alpha))
                                else studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(posX + width, posY + width, endPosX, endPosY, color.alpha(
                                    alpha
                                ))
                            }
                            ...
                            if (mode == Mode.Box) {
                                // Left
                                studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(posX - 1, posY, posX + boxWidth, endPosY + .5, black)
                                // Top
                                studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(
                                    posX - 1,
                                    posY - .5,
                                    endPosX + .5,
                                    posY + .5 + boxWidth,
                                ...
                                // Left
                                studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(posX - .5, posY, posX + boxWidth - .5, endPosY, color2)
                                // Bottom
                                studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(posX, endPosY - boxWidth, endPosX, endPosY, color2)
                                // Top
                                studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(posX - .5, posY, endPosX, posY + boxWidth, color2)
                                // Right
                                studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(endPosX - boxWidth, posY, endPosX, endPosY, color2)
                            }
                            ...
                            if (displayName.value) {
                                ...
                                studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer.drawStringWithShadow(
                                    message,
                                    (posX + dif).toFloat() - studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer
                            ...
                            if (healthBar) {
                                ...
                                if (health > 0 && healthBar) {
                                    studio.coni.epsilon.util.graphics.RenderUtils2D.drawOutline(posX - 4, posY - .5, 2.0, endPosY - posY + .5, .5, black)
                                    studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(
                                        posX - 4,
                                        posY - .5,
                                        posX - 2,
                                    ...
                                    studio.coni.epsilon.util.graphics.RenderUtils2D.drawRectFilled(
                                        ...
                                        posX - 2.5,
                                        endPosY,
                                        studio.coni.epsilon.util.EntityUtil.getHealthColor(entity, 255)
                                    )
                                }
                                if (split)
                                if (-difference > 50.0)
                                ...
                                if (healthNumber.value) {
                                    ...
                                    studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer.drawStringWithShadow(healthNum, posX.toFloat() - (studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer.getWidth(healthNum, 0.53f)),
                                        (endPosY - hpHeight).toFloat() - studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer.getHeight(0.53f),
                                ...
                                if (potion) {
                                    ...
                                    if (entity.isPotionActive(MobEffects.STRENGTH)) {
                                        studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer.drawStringWithShadow("Strength " + (entity.getActivePotionEffect(MobEffects.STRENGTH)!!.amplifier + 1), endPosX.toFloat() + 1.5f, startY, ColorRGB(
                                            ColorUtils.argbToRgba(MobEffects.STRENGTH.liquidColor or -0x1000000)), 0.55f)
                                        startY += studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer.getHeight(0.55f) + 1f
                                    }
                                    if (entity.isPotionActive(MobEffects.WEAKNESS)) {
                                        studio.coni.epsilon.util.graphics.font.renderer.MainFontRenderer.drawStringWithShadow("Weakness " + (entity.getActivePotionEffect(MobEffects.WEAKNESS)!!.amplifier + 1), endPosX.toFloat() + 1.5f, startY, ColorRGB(
