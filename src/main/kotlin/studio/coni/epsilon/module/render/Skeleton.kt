...
import studio.coni.epsilon.event.events.RenderEntityModelEvent
...
import studio.coni.epsilon.util.math.MathUtils.getInterpolatedRenderPos
...
object Skeleton :
    ...
    init {
        onRender3D {
            runSafe {
                studio.coni.epsilon.util.graphics.RenderUtils3D.glPre(1.0f)
                ...
                studio.coni.epsilon.util.graphics.RenderUtils3D.glPost()
            }
        }
