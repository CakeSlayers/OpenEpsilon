        ...
        onRender3D {
            runSafe {
                ...
                if (isThrowable(mc.player.heldItemMainhand)) {
                    ...
                    studio.coni.epsilon.util.graphics.RenderUtils3D.glPre(1.5f)
                    GL11.glEnable(2848)
                    ...
                    if (landingPosition != null && landingPosition.typeOfHit == RayTraceResult.Type.BLOCK) {
                        ...
                        studio.coni.epsilon.util.graphics.RenderUtils2D.drawBorderedRect(-8.25f, -8.25f, 8.25f, 8.25f, 1f, color.alpha(255), color.alpha(69))
                    }
