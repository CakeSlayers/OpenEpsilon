...
import studio.coni.epsilon.module.movement.Speed.getBaseMoveSpeed
...
object LongJump : Module(name = "LongJump", description = "Make you can jump a long distance", category = Category.Movement) {
    ...
    init {
        ...
        onTick {
            ...
            if (EntityUtil.isMoving(mc.player) && player.onGround && player.collidedVertically && stage > 2) {
                ++groundTicks
            }
            if (groundTicks > 1) {
