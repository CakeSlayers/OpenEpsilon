...
import studio.coni.epsilon.management.HotbarManager.serverSideItem
...
import studio.coni.epsilon.util.combat.CrystalUtils.canPlaceCrystalOn
import studio.coni.epsilon.util.combat.CrystalUtils.isResistant
import studio.coni.epsilon.util.delegate.CachedValueN
...
import studio.coni.epsilon.util.inventory.operation.swapToSlot
import studio.coni.epsilon.util.math.RotationUtils.getRotationTo
import studio.coni.epsilon.util.math.VectorUtils.setAndAdd
import studio.coni.epsilon.util.math.VectorUtils.toViewVec
...
import studio.coni.epsilon.util.world.rayTraceVisible
...
import studio.coni.epsilon.util.extension.*
import studio.coni.epsilon.util.inventory.slot.*
import studio.coni.epsilon.util.math.*
...
object ZealotCrystalPlus :
    ...
    private /*inline*/ fun toLong(x: Double, y: Double, z: Double): Long {
        return studio.coni.epsilon.util.math.vector.toLong(x.fastFloor(), y.fastFloor(), z.fastFloor())
    }
